...
a persistence unit "EvaluacionWSGutamaFannyPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSGutamaFanny\pom.xml":
...
artifact ("EvaluacionWSGutamaFanny.war") is already built. You can build
